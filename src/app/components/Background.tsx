...
const Background: React.FC = () => {
  useEffect(() => {
    const canvas = document.querySelectorAll('#bg canvas');
    const background = canvas[0] as HTMLCanvasElement;
    const foreground1 = canvas[1] as HTMLCanvasElement;
    const foreground2 = canvas[2] as HTMLCanvasElement;
